...
contract StrategyProxy {
    ...
    IProxy public constant proxy =
        IProxy(0xF147b8125d2ef93FB6965Db97D6746952a133934); // Refer to this as "voter" contract
    ...
    address public feeRecipient =
        address(0xc5bDdf9843308380375a611c18B50Fb9341f502A); // Default value is yveCRV
    ...
    function approveStrategy(address _gauge, address _strategy) external {
        require(
            msg.sender == governance || msg.sender == factory,
            "!governance"
        );
